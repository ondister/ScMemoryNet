...
namespace ScEngineNet.Native
{
    internal static partial class NativeMethods
    {
        ...
        internal static extern IntPtr sc_iterator3_f_a_a_new(IntPtr context, WScAddress BeginElementAddress, ElementTypes arcType, ElementTypes endElementType);
        ...
        [DllImport(ScEngineNet.ScMemoryDllName, CallingConvention = ScEngineNet.DefaultCallingConvention, CharSet = ScEngineNet.DefaultCharset)]
        internal static extern IntPtr sc_iterator3_a_a_f_new(IntPtr context, ElementTypes beginElementType, ElementTypes arcType, WScAddress EndElementAddress);
        ...
        [DllImport(ScEngineNet.ScMemoryDllName, CallingConvention = ScEngineNet.DefaultCallingConvention, CharSet = ScEngineNet.DefaultCharset)]
        internal static extern IntPtr sc_iterator3_f_a_f_new(IntPtr context, WScAddress beginElementAddress, ElementTypes arcType, WScAddress endElementAddress);
        ...
        [DllImport(ScEngineNet.ScMemoryDllName, CallingConvention = ScEngineNet.DefaultCallingConvention, CharSet = ScEngineNet.DefaultCharset)]
        internal static extern bool sc_iterator_compare_type(ElementTypes elementType, ElementTypes iteratorType);
    }
}
