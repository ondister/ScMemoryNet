...
namespace ScEngineNet
{
    ...
    internal static partial class NativeMethods
    {
        ...
        [DllImport(ScEngineNet.ScMemoryDllName, CallingConvention = ScEngineNet.DefaultCallingConvention, CharSet = ScEngineNet.DefaultCharset)]
        internal static extern WScAddress sc_memory_node_new(IntPtr context, ElementType elementType);

        [DllImport(ScEngineNet.ScMemoryDllName, CallingConvention = ScEngineNet.DefaultCallingConvention, CharSet = ScEngineNet.DefaultCharset)]
        internal static extern WScAddress sc_memory_link_new(IntPtr context);

        [DllImport(ScEngineNet.ScMemoryDllName, CallingConvention = ScEngineNet.DefaultCallingConvention, CharSet = ScEngineNet.DefaultCharset)]
        internal static extern WScAddress sc_memory_arc_new(IntPtr context, ElementType elementType,  WScAddress beginElement,  WScAddress endElement);

        [DllImport(ScEngineNet.ScMemoryDllName, CallingConvention = ScEngineNet.DefaultCallingConvention, CharSet = ScEngineNet.DefaultCharset)]
        internal static extern ScResult sc_memory_get_element_type(IntPtr context,  WScAddress scAddress, out ElementType elementType);

        [DllImport(ScEngineNet.ScMemoryDllName, CallingConvention = ScEngineNet.DefaultCallingConvention, CharSet = ScEngineNet.DefaultCharset)]
        internal static extern ScResult sc_memory_change_element_subtype(IntPtr context,  WScAddress scAddress, ElementType elementType);
