...
namespace ScMachineWrapperTest
{
    ...
    public class ScMemoryContextTests
    {
        ...
        public void CreateNodeTestIdentifiers()
        {
            ...
            Assert.AreEqual(ruId, node5.MainIdentifiers[ScDataTypes.Instance.LanguageRu].ToString());
            Assert.AreEqual(enId,  node5.MainIdentifiers[ScDataTypes.Instance.LanguageEn].ToString());
